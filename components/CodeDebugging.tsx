  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="code" className="block text-sm font-medium text-gray-300 mb-2 font-semibold">Code with Issues</label> 
        ...
        <div>
          <label htmlFor="error" className="block text-sm font-medium text-gray-300 mb-2 font-semibold">Error Message (Optional)</label> 
          <div className="relative">
            <textarea
              id="error"
              value={error}
      ...
      {debugging && (
        <div className="mt-6 animate-fade-in">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-xl font-semibold">Debugging Result</h3>
          </div>
